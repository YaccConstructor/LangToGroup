...
cmd2SIDCmd (tapeStates, commands) = do 
    ...
    let cmd2SIDCmdInternal tapeStates commands acc =
            case commands of
                h : t   | checkLeftBounding h -> cmd2SIDCmdInternal tapeStates t $ h : acc
    ...
    cmd2SIDCmdInternal tapeStates commands []
