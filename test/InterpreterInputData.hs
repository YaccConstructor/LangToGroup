module InterpreterInputData (
    InterpreterInputData, inAlphabet, inGrammar,
...
testData1 = IN testGr1 alphabet1
...
testData2 = IN testGr2 alphabet2
...
testData3 = IN testGr3 alphabet3
...
testData4 = IN testGr4 alphabet4
...
testData5 = IN testGr5 alphabet5

alphabet5 :: Set.Set [Char]
alphabet5 = Set.fromList ["!","#","(",")","*","+","-","0","1","2","3","4","5","6","7","B","C","D","S","b","c"]
testGr5 :: Grammar
